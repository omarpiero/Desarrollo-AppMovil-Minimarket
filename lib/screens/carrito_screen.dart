      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: MinimarketTheme.primaryYellow.withValues(alpha: 0.3),
            ),
          ),
          child: Row(
            children: [
              Icon(
                ...
                size: 18,
                color: MinimarketTheme.primaryYellowDark.withValues(alpha: 0.8),
              ),
              const SizedBox(width: 8),
              const Expanded(
                child: Text(
                  'Desliza a la izquierda para eliminar un producto',
                  style: TextStyle(
                    fontSize: 12,
                    color: MinimarketTheme.textSecondary,
              ...
              Icon(
                ...
                size: 16,
                color: MinimarketTheme.error.withValues(alpha: 0.5),
              ),
            ],
          ),
        ),
