              ...
              if (kDebugMode) ...[
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    icon: const Icon(Icons.build_rounded, color: MinimarketTheme.warning),
                    label: const Text('HERRAMIENTAS DEV', style: TextStyle(color: MinimarketTheme.textPrimary)),
                    style: OutlinedButton.styleFrom(
                      side: const BorderSide(color: MinimarketTheme.warning),
          ...
          Card(
            ...
            child: Column(
              children: [
                ...
                // Mostrar herramientas dev solo en modo debug
                if (kDebugMode) ...[
                  const Divider(height: 1, indent: 50),
                  ListTile(
                    leading: const Icon(Icons.build_rounded, color: MinimarketTheme.warning),
                    title: const Text('Herramientas Dev', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                    trailing: const Icon(Icons.chevron_right, size: 20),
                    onTap: () {
                      Navigator.push(
                        context,
