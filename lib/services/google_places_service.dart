...
class GooglePlacesService {
  ...
  /// Convierte coordenadas (lat/lng) en una dirección legible usando la Geocoding API.
  Future<String?> reverseGeocode(LatLng ubicacion) async {
    try {
      final uri = Uri.https(
        'maps.googleapis.com',
      ...
      // Buscar el resultado más específico (street_address > route > locality)
